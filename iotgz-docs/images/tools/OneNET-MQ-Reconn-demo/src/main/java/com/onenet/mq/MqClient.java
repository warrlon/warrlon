...
public class MqClient {
    ...
    public synchronized boolean connect(){
        ...
        String clientID = "aaa"; //用户自定义合法的UTF-8字符串，无需修改
        String serverURI = "ssl://183.230.40.96:8883";
        
        String userName = "your_mq_name"; //MQ实例名称
        String mqTopic = "your_topic_name"; //topic名称
        String mqSub = "your_sub_name"; // 订阅名称
    ...
    private void resetOptions(){
        String userName = "your_mq_name"; //MQ实例名称
        String accessKey = "vIEkeHlLfu/CNLTizXElY0+xh31JHQj4E0u1Ylf1MEk="; //MQ access_key
