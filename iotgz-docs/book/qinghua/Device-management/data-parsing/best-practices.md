...
![创建产品](/images\qinghua\device-management\create-product.png)

**开发产品物模型**

产品物模型管理页面，添加一个标识符为humi的浮点型功能点、标识符为temp的整数型功能点。

![创建物模型](/images\qinghua\device-management\creat-object-model.png)
...
![脚本调试](/images\qinghua\device-management\script-draft.png)
...
![运行结果](/images\qinghua\device-management\execution-results.png)
...
![属性设置](/images\qinghua\device-management\properties-set.png)
...
![功能测试](/images\qinghua\device-management\function-test.png)

【运维监控】下选择设备调试功能，调试页面选择产品下某一设备，使用应用模拟器模拟平台服务命令下发。

![调试设备](/images\qinghua\device-management\device-debug.png)
...
![服务调用](/images\qinghua\device-management\service-calls.png)